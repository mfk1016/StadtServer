...
public class PiglinEnchantmentOrigin extends LootEnchantmentOrigin {

    public static final String TYPE = "enchantment.piglin";

    public PiglinEnchantmentOrigin(int chance, CustomEnchantment enchantment, int[] levelWeights) {
        super(TYPE, chance, enchantment, levelWeights);
    }

    public static PiglinEnchantmentOrigin fromJson(JsonObject object, Gson gson) {
        ...
        return new PiglinEnchantmentOrigin(chance, realEnchantment, weights);
    }
}
